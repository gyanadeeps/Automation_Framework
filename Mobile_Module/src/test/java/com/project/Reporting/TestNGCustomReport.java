...
import com.project.data.SystemProperties;
import org.testng.*;
...
import static com.project.data.SystemProperties.FILE_SEPERATOR;
import static com.project.data.SystemProperties.USERDIR;
...
//writer.print(".skippedeven td {background-color: #CCC}");
    ...
    protected void writeBody() {
        ...
        writer.print("<body>");
        writeReportTitle("Automation Report");
        writeProjectDetails();
        writeSuiteSummary();
    ...
    protected void writeProjectDetails() {
        ...
        writer.print("<td> "+ SystemProperties.BUILD_URL+"Automation_5fAutomation_5fReport/" +" </td>");
        writer.print("</tr>");

        writer.print("<tr>");
        writer.println("<th>APPLICATION_BUILD_NUMBER"+"&#x2a;</td>");
        writer.print("<td> "+ SystemProperties.APPLICATION_BUILD_VERSION+" </td>");
        writer.print("</tr>");

        writer.print("<tr>");
        writer.println("<th>Environment URL </td>");
        writer.print("<td> "+ SystemProperties.URL +" </td>");
        writer.print("</tr>");

        writer.print("<tr>");
        writer.println("<th>Browser</td>");
        writer.print("<td> "+SystemProperties.MOBILE_BROWSER+"</td>");
        writer.print("</tr>");
        writer.print("<tr>");
 ...
 writer.print("</th></tr>");*/
    ...
    protected void writeScenarioSummary() {
        ...
        int scenarioIndex = 0;
        for (SuiteResult suiteResult : suiteResults) {
            writer.print("<tbody><tr style=\"background-color:Orange;\"><th colspan=\"5\">");
